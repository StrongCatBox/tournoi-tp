    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="info.php"><i class="fas fa-info-circle"></i> Infos</a></li>
                <li><a href="equipe.php"><i class="fas fa-users"></i> Équipe</a></li>
                <li><a href="matchs.php"><i class="fas fa-gamepad"></i> Matchs</a></li>
                <li><a href="classement.php"><i class="fas fa-list"></i> Classement</a></li>
            </ul>
        </nav>
    </header>
